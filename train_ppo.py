...
from pong_custom import CustomPongEnv
...
if __name__ == "__main__":
    ...
    early_stop, reward_list = train(env_name='CartPole-v1', num_steps=1000, mini_batch_size=16, ppo_epochs=4, threshold=threshold)