...
class CustomPongEnv(gym.Env):
    ...
    def _get_one_frame_obs(self):
        ...
        # Ball
        obs[self.ball_position[0]-self.ball_radius:self.ball_position[0]+self.ball_radius, self.ball_position[1]-self.ball_radius:self.ball_position[1]+self.ball_radius] = 255
        
        # Yasser Paddle
        obs[self.side_wall_length - self.paddle_height - 1:self.side_wall_length - self.paddle_height + 1, self.paddle_center - self.paddle_halfwidth:self.paddle_center+self.paddle_halfwidth] = 255
        
        # AI Paddle
        obs[self.side_wall_length - self.paddle_height - 1:self.side_wall_length - self.paddle_height + 1, self.ai_paddle_center - self.paddle_halfwidth:self.paddle_center+self.paddle_halfwidth] = 127
